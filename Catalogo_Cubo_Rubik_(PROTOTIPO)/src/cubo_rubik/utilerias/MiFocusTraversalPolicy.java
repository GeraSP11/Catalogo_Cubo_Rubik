 ...
 * @author Oracle
 */
public class MiFocusTraversalPolicy extends FocusTraversalPolicy {
	/**
	 ...
	 * 
	 * @param order
	 *            Vector con los componentes ordenados que recibirán el foco.
	 */
	public MiFocusTraversalPolicy(Vector<Component> order) {
	 ...
	 *            Ciclo de foco.
	 * @param aComponent
	 *            El componente a partir del cual se obtendrá el siguiente.
	 ...
	 *            Ciclo de foco.
	 * @param aComponent
	 *            El componente a partir del cual se obtendrá el anterior.
